...
class SocketFileObjectWrapper(socket._fileobject):
    ...
    def __init__(self, *arguments, **keywords):
        ...
        return builtins.super(self.__class__, self).__init__(
            *arguments, **keywords)
    ...
    def readline(self, *arguments, **keywords):
        ...
        if self.first_read_line is False:
            try:
                '''Take this method via introspection.'''
                self.first_read_line = builtins.super(
                    self.__class__, self
                ).readline(*arguments, **keywords)
            ...
            try:
                '''Take this method via introspection.'''
                return builtins.super(self.__class__, self).readline(
                    *arguments, **keywords)
            except(
                socket.herror, socket.gaierror, socket.timeout,
                socket.error
...
# #
        ...
        parent_function = server.HTTPServer.process_request
        '''
...
# #
        ...
        return builtins.super(self.__class__, self).stop(
...
# #
        ...
        if not __test_mode__:
            for period_in_seconds in (1, 3, 6, 12):
                '''Take this method via introspection.'''
                try:
                    return builtins.super(self.__class__, self).__init__(
...
# # python3.5     def do_POST(self: Self) -> Self:
    def do_POST(self):
        '''
            ...
            Object of "CGIHTTPRequestHandler" with request uri "/" and param...
        '''
        return self._do_data_request(type='do_POST')
...
# # python3.5     def do_PATCH(self: Self) -> Self:
    def do_PATCH(self):
        '''
            ...
            Object of "CGIHTTPRequestHandler" with request uri "/" and param...
        '''
        return self._do_data_request(type='do_PATCH')
...
# # python3.5     def do_DELETE(self: Self) -> Self:
    def do_DELETE(self):
        '''
            ...
            Object of "CGIHTTPRequestHandler" with request uri "/" and param...
        '''
        return self._do_data_request(type='do_DELETE')
...
# # python3.5     def do_PUT(self: Self) -> Self:
    def do_PUT(self):
        '''
            ...
            Object of "CGIHTTPRequestHandler" with request uri "/" and param...
        '''
        return self._do_data_request(type='do_PUT')
...
# #
        ...
        if not (self.response_sent or __test_mode__):
            ...
            '''Take this method via introspection.'''
            builtins.super(self.__class__, self).send_response(
                *arguments, **keywords)
        return self
...
# # python3.5             pass
            ...
            '''Take this method via introspection.'''
            builtins.super(self.__class__, self).send_error(
...
# #
        ...
        '''Take this method via introspection.'''
        if not __test_mode__:
            file_handler = builtins.super(self.__class__, self).list_directory(
...
# #
        ...
        if not (self.headers_ended or __test_mode__):
            ...
            '''Take this method via introspection.'''
            builtins.super(self.__class__, self).end_headers(
                *arguments, **keywords)
        return self
...
# #
        ...
        '''
        '''Take this method via introspection.'''
        result = builtins.super(self.__class__, self).setup(
            *arguments, **keywords)
